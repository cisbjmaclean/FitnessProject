...
public class Authenticate extends Action {
    ...
    public ActionForward execute(
        ...
        if (successfulLogin) {
            ...
            //Dont like having a Member bean and a member form but that's how it is for now.
            
            MemberForm memberForm = new MemberForm();
            memberForm.setMemberId(Integer.parseInt(member.getMemberId()));
            memberForm = MemberBO.loadDetails(memberForm);
            member.setMemberType(memberForm.getUserType());
